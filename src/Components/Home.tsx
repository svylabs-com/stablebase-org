...
//import universe from "../assets/svg/bannerz.svg";
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4 text-center md:text-left mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-wide text-white">STABLEBASE</h1>
          <h2 className="text-sm sm:text-base md:text-lg text-[#CCCCCC]">A marketdriven stablecoin protocol with a simple pay as you go pricing</h2>
