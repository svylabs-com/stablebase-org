                ...
                <div className="space-y-8 2xl:space-y-10 container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 2xl:gap-10">
                        {[
                            ...
                            <GradientBackgroundContainer key={i} colorRight="#faaf25b3"> 
                                <div
                                    className="p-6"
                                >
                                    <h3 className="text-xl 2xl:text-2xl font-semibold text-gray-100 mb-3">{item.title}</h3>
                                    <p className="2xl:text-lg text-gray-400">{item.content}</p>
                                </div>
