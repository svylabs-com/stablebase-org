  ...
  return (
    ...
    <div className="bg-black text-white min-h-screen p-6 flex flex-col items-center justify-center md:px-6 lg:px-10">
      <div className="flex w-full justify-end">
        <Link to="/" className="text-gray-400 hover:text-yellow-500 transition duration-300 mb-6" title="Back to Home">
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-semibold text-yellow-500 mb-4">Why Get Involved?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4 p-4 border border-gray-700 rounded-lg">
            <h2 className="text-2xl font-semibold flex items-center">
              <FontAwesomeIcon icon={faUsers} className="text-yellow-500 text-3xl mr-4" />
              Users
            </h2>
            <div>
          ...
          <div className="space-y-4 p-4 border border-gray-700 rounded-lg">
            <h2 className="text-2xl font-semibold flex items-center">
              <FontAwesomeIcon icon={faWallet} className="text-yellow-500 text-3xl mr-4" />
              Yield Farmers
            </h2>
            <div>
          ...
          <div className="space-y-4 p-4 border border-gray-700 rounded-lg">
            <h2 className="text-2xl font-semibold flex items-center">
              <FontAwesomeIcon icon={faCode} className="text-yellow-500 text-3xl mr-4" />
              Developer
            </h2>
            <div>
              <h3 className="text-xl font-semibold">Contribute / Review code</h3>
              <a href="https://github.com/svylabs/stablebase" className="text-gray-400 hover:text-yellow-500 transition duration-300">
                Visit our Github
              </a>
            ...
            <div>
              ...
              <a href="https://github.com/svylabs/stablebase/blob/main/WHITEPAPER.pdf" className="text-gray-400 hover:text-yellow-500 transition duration-300">
                Read our Whitepaper
              </a>
          ...
          <div className="space-y-4 p-4 border border-gray-700 rounded-lg">
            <h2 className="text-2xl font-semibold flex items-center">
              <FontAwesomeIcon icon={faDollarSign} className="text-yellow-500 text-3xl mr-4" />
              Investors
            </h2>
            <div>
