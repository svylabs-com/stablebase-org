        ...
        <section className="my-10 lg:px-10 lg:my-20">
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between">
                ...
                <div className="hidden lg:block w-full lg:w-1/2 lg:pr-10">
                    ...
                    <h4 className="text-lg md:text-xl font-semibold mb-4 text-yellow-300">
                    Bitcoin backed
                    </h4>
                ...
                <div className="relative w-full lg:w-1/2 lg:bg-gray-400 lg:p-6 rounded-md">
                    <img
                        ...
                        className='w-full h-[95vh] object-fill xs:h-[80vh] sm-xs:h-[75vh] md:object-cover opacity-40 md:h-[30rem] lg:h-full lg:static lg:shadow-lg lg:rounded-md lg:opacity-100'
                    />
                    ...
                    <div className="absolute inset-0 bg-[#161619] bg-opacity-50 lg:hidden flex flex-col justify-center items-center text-center p-2">
                        ...
                        <h4 className="text-lg md:text-xl font-semibold mb-2 text-yellow-300">
                            Bitcoin backed
                        </h4>
                        <p className="text-base lg:text-lg leading-relaxed mb-4">
                            Bitcoin's value is a trillion dollar worth, but there are no decentralized borrowing solutions for Bitcoin. By using Bitcoin as collateral on a sufficiently trust minimized L2, we will unlock trillion dollar worth of collateral onchain.
