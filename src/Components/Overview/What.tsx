...
const What: React.FC = () => {
    return (
        <section className="my-5 lg:px-10">
            <h1 className="p-2 md:mb-5 md:py-4 font-bold text-2xl md:text-3xl lg:text-4xl px-4 md:px-6 lg:px-0 lg:mx-auto lg:flex items-center justify-center  text-yellow-500">
                Protocol Overview
            </h1>
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="relative w-full lg:w-1/2 lg:bg-gray-400 lg:p-6 rounded-md">
                    <img
                        ...
                        className="w-full h-[90vh] object-fill xs:h-[80vh] sm-xs:h-[70vh] md:object-cover opacity-40 md:h-[20rem] lg:h-full lg:static lg:shadow-lg lg:rounded-md lg:opacity-100"
                    />
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 lg:hidden flex flex-col justify-center items-center text-center p-2">
                        ...
                        <h4 className="text-md md:text-xl font-semibold mb-3 text-yellow-300">
